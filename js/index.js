  ...
  observeParents: true,
   ...
   $(function(){
    ...
    $('.contact-link-about').on('click',function(){
     ...
     $('.home-link').on('click',function(){
      gsap.to('.anniversary-project',.5,{scale:.9});
      gsap.to('.anniversary-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.anniversary-project',0,{display:'none',delay:.7});
      gsap.to('.baby-project',.5,{scale:.9});
      gsap.to('.baby-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.baby-project',0,{display:'none',delay:.7});
      gsap.to('.couple-project',.5,{scale:.9});
      gsap.to('.couple-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.couple-project',0,{display:'none',delay:.7});
      gsap.to('.traditional-project',.5,{scale:.9});
      gsap.to('.traditional-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.traditional-project',0,{display:'none',delay:.7});
      gsap.to('#about',.5,{scale:.9});
      gsap.to('#about',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#about',0,{display:'none',delay:.7});
    ...
    $('.traditional-project-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.traditional-project',0,{display:'block',delay:.7})
      gsap.to('.traditional-project',.5,{scale:1,delay:1.1})
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    $('.couple-project-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.couple-project',0,{display:'block',delay:.7})
      gsap.to('.couple-project',.5,{scale:1,delay:1.1})
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    $('.baby-project-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.baby-project',0,{display:'block',delay:.7})
      gsap.to('.baby-project',.5,{scale:1,delay:1.1})
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    $('.anniversary-project-link').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.anniversary-project',0,{display:'block',delay:.7})
      gsap.to('.anniversary-project',.5,{scale:1,delay:1.1})
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    ...
    $('.traditional-close').on('click',function(){
      gsap.to('.traditional-project',.5,{scale:.9});
      gsap.to('.traditional-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.traditional-project',0,{display:'none',delay:.7});
      gsap.to('#home',0,{display:'block',delay:.7})
    ...
    $('.couple-close').on('click',function(){
      gsap.to('.couple-project',.5,{scale:.9});
      gsap.to('.couple-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.couple-project',0,{display:'none',delay:.7});
      gsap.to('#home',0,{display:'block',delay:.7})
    ...
    $('.anniversary-close').on('click',function(){
      gsap.to('.anniversary-project',.5,{scale:.9});
      gsap.to('.anniversary-project',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('.anniversary-project',0,{display:'none',delay:.7});
      gsap.to('#home',0,{display:'block',delay:.7})
